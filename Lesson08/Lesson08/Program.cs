...
namespace Lesson08_2
{
	class Program
	{
		static void Main(string[] args)
		{
            ...
            ////списки
            ////ввести неско-ко значений и вывести их среднее
            //List<double> MyListDouble = new List<double>();
            //Console.WriteLine("Введите несколько значений, а затем stop:");
            //do
            //{
            ...
            //    try
            //    {
            //        inputDouble = double.Parse(inputStr);
            //    }
            //    catch (Exception e)
            //    {
            ...
            //double Avg;
            //int Quantity;
            //foreach (double tempDouble in MyListDouble)
            //    Total += tempDouble;
            //Quantity = MyListDouble.Count;
            //Avg = Total / Quantity;
            //Console.WriteLine("Введено {0} значений, среднее значение {1}", Quantity, Avg);
